...
try:
    ...
    parser.add_argument('-v', action='store_true', help='If True the script will run on verbose mode')
    parser.add_argument('-fit', action='store_true', help='If True the program will also fit the data')
...
plt.hist((sorted_R), bins=25)
plt.hist((radii/ c.R_sun.to('cm').value), bins=25)
plt.show()
